...
class TerrainChunk {
  ...
  _Init(params) {
    ...
    this._plane = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({
            ...
            map: THREE.ImageUtils.loadTexture('./resources/grass_rock_texture.jpg')
        }));
  ...
  Rebuild() {
    ...
    if (this._params.heightGenerators.length > 1 && offset.x == 0 && offset.y == 0) {
      ...
      const GREEN = new THREE.Color(0xFFFFFF);
...
class TerrainChunkManager {
  ...
  _InitNoise(params) {
    ...
    // heightmapRollup.add(params.guiParams.heightmap, "height", 0, 256).onChange(
    //     onNoiseChanged);
  }
